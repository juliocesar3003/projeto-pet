...
public class StageFinalizado implements AgendamentoStage {
    ...
    @Override
    public void setAtributosFinalizado(AgendamentoBuilder builder, AgendamentoRequest request,Double valorTotal) {
        builder.BuildHoraSaida(request.horarioSaidaRealizada())
                .BuildStatus(StatusAgendamento.FINALIZADO)
                .BuildValorTotal(valorTotal)
                .build();
    }
}
